...
const CarritoProvider = ( {children} ) => {
    ...
    const data = {
        ...
        eliminarProductoDelCarritoContext, //lo pongo aca,para compartir con el resto de componentes que tiene contextp
